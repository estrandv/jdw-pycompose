...
Synth("Mbd0 (hh0/hh0[ofs0]) bd4 (hh0/(hh0 hh4)[=0.5])", "drum2").play("KorgT3", SendType.PLAY_SAMPLE)
Synth("Mcy1[=16 #0.2]", "drm").play("example", SendType.PLAY_SAMPLE)
Synth("M (32) _ _ _ :: >0.1 #0.2 =0.25 relT0.2", "drill").play("brute")
Synth("M2 _ 2 2 4 _ 4 4 3 _ 3 3 1 _ 1 1 :: #0.4 >0.1 =0.5 relT0.2", "bass").play("brute")
Synth("M (11/13/11/12)[=0 >2 relT2 #0.2] 7 9[=0.5] 8 5 _ 9 6 (2/(8 9)[=0.25])[=0.5] :: #0.3 >0.1 =0.5 relT0.2", "solo").play("brute")
